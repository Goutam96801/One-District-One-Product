  ...
  return (
    ...
    <AnimationWrapper keyValue={type}>
      <div className="relative">
        <h1 className="absolute top-0 left-0 z-[-10] text-[250px] font-gelasio bg-red w-full h-full flex items-center justify-center">CUSTOMER</h1>
      <section className="h-cover flex items-center justify-center">
            
            <form
              onSubmit={handleSubmit}
              className="w-[80%] max-w-[400px] z-10 h-[550px] bg-blur rounded-lg py-3 px-8"
            >
              ...
              >
                {type === "sign-in" ? "Log In" : "Create new account"}
              </button>
          ...
          {
            type === "sign-in" ? 
            <p className="text-white">Don't have an account ? <Link to="/signup">Signup here</Link></p> :
